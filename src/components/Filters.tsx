...
import { Music2, Smile, ListFilter } from "lucide-react";
...
const Filters: React.FC = () => {
  const { selectedGenre, setSelectedGenre } = useRadioStore();
    ...
    <div className="w-full">
      <div className="bg-white/30 backdrop-blur-md shadow-lg rounded-lg p-3">
        ...
        <div className="flex mb-3">
          <button
            className={`flex-1 py-2 px-4 rounded-md text-sm font-medium flex items-center justify-center transition-colors duration-150 cursor-pointer bg-zinc-800 text-white shadow-sm`}
          >
